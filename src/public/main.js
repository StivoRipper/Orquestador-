...
function updatetotal() {
  ...
  //salvar total para localstorage
  localStorage.setItem("cartTotal", total);
}

//Guardar Item en carro cuando la pagona refresque con localstorage
